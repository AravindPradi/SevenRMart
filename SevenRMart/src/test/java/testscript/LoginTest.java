...
public class LoginTest extends Base {
	...
	@Test(description = "This is to verify user login with correct username and wrong password", groups = {
	...
	@Test(dataProvider = "InvalidLoginData", description = "This is to verify user login with incorrect username and incorrect password", groups = {
			"smoke", "regression" }, priority = 3)
	...
	@Test(description = "This is to verify the user login with incorrect username and correct password", groups = {
	...
	public Object[][] getDataFromDataProvider() {
		return new Object[][] {
				...
				new Object[] { "abc", "abc" }, new Object[] { "123", "123" } };
	}
