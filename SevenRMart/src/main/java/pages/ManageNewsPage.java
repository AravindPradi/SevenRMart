...
public class ManageNewsPage {
	...
	@FindBy(xpath = "//a[@class=' nav-link' and .//p[text()='Manage product']]")
	...
	@FindBy(xpath = "//h3[@class='card-title' and text()='Enter News Informations']")
	private WebElement addNewsPage;
	@FindBy(xpath = "//textarea[@id='news']")
	private WebElement addNewsInputField;
