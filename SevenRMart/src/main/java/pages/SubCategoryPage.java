...
public class SubCategoryPage {
	...
	@FindBy(xpath = "//h4[@class=\"card-title\" and text()='List Sub Categories']")
	private WebElement isSubCategoryPage;
	@FindBy(xpath = "//a[@onclick='click_button(1)' and contains(text(), 'New')]")
	private WebElement addNewButton;
	@FindBy(xpath = "//select[@id='cat_id']")
	private WebElement categoryDropdown;
	@FindBy(xpath = "//input[@id=\"subcategory\"]")
	private WebElement subCategeoryInput;
	@FindBy(xpath = "//input[@id=\"main_img\"]")
	private WebElement uploadImage;
	@FindBy(xpath = "//button[@name=\"create\"]")
	private WebElement saveButton;
	@FindBy(xpath = "//h5[normalize-space(text()= ' Sub Category Created Successfully')]")
